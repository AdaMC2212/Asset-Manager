...
export const MoneyHeader: React.FC<MoneyHeaderProps> = ({
  ...
  return (
    <div className="flex flex-row items-center justify-between gap-2 py-1 md:gap-6">
      <div
      ...
      >
        ...
        <div className="flex min-w-[96px] flex-col items-center px-1 md:min-w-[140px] md:px-2">
          <span className="text-sm font-bold tracking-tight text-white md:text-xl">{monthName}</span>
